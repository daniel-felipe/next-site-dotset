  ...
  return (
    <section className="bg-[url(/support-background.svg)] bg-cover bg-no-repeat md:py-32">
      <div className="container flex flex-col items-center gap-12">
        <h2 className={`${ptSansCaption.className} max-w-lg text-balance text-center text-heading-xl text-gray-100`}>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="flex flex-col text-left gap-4 rounded-lg p-6 bg-blue-400">
            ...
            <p className="text-body-sm text-gray-200">Adicione seu logo, favicon, cores no seu catálogo e tenha tudo com sua cara.</p>
          </div>
